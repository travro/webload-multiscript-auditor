    ...
    public static class SqlCommands
    {
        ...
        public static ObservableCollection<string> GetTestCollections(ScriptAttribute attribute, SqlConnection cnn)
        {
            ...
            using (var cmd = new SqlCommand("", cnn))
            {
                switch (attribute)
                {
                    case ScriptAttribute.TestName: cmd.CommandText = "USE WLScriptsDB SELECT DISTINCT test_name FROM Tests"; ; break;
                    case ScriptAttribute.BuildName: cmd.CommandText = "USE WLScriptsDB SELECT DISTINCT build_version FROM Tests"; ; break;
